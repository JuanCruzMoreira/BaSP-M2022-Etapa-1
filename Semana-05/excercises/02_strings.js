...
let stringPrim = stringEx2b.substring(0,3);
...
let stringUlt = stringEx2c.substring(stringEx2c.length-3, stringEx2c.length);
...
let stringEx2d = 'este sTRING tiene VARias LeTRas en MAyúsCula';
let solEx2d = stringEx2d.substring(0,1).toUpperCase() + stringEx2d.substring(1,stringEx2d.length).toLowerCase();
console.log(solEx2d);
...
/*Crear una variable de tipo string con al menos 10 caracteres y algún espacio en blanco. Encontrar
 ...
 let stringEx2e = 'Tengo un espacio en blanco en la sexta posición';
 let posEsp = stringEx2e.indexOf(' ');
...
/*  Crear una variable de tipo string con al menos 2 palabras largas (10 caracteres y algún espacio 
  ...
  let stringEx2f = 'ornitorrincos paralelepípedo';
  let posEsp2 = stringEx2f.indexOf(' ');
  let solEx2f = stringEx2f.substring(0, 1).toUpperCase() + stringEx2f.substring(1, posEsp2).toLowerCase()
