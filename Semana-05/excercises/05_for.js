...
for (let word = 0; word < wordsArray.length; word++) {
  sentence += ' ' + wordsArray[word];
}

alert(sentence);

/* Crear una array vacío y con un bucle for de 10 repeticiones. Llenar el array con el número de 
la repetición, es decir que al final de la ejecución del bucle for debería haber 10 elementos 
